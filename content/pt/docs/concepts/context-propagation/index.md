...
Com a propagação de contexto, os [sinais](../signals/) ([rastros](../signals/traces/),
[métricas](../signals/metrics/), e [logs](../signals/logs/)) podem ser correlacionados
...
Quando o serviço A chama o serviço B, o serviço A inclui um ID de rastro (_trace ID_) e um ID de
trecho (_span ID_) como parte do contexto. O serviço B utiliza
